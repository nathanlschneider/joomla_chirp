...
namespace Chirp\Component\Chirp\Administrator\View\Products;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_CHIRP_TITLE_PRODUCTS'), "generic");
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_chirp&view=products');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => Text::_('COM_CHIRP_PRODUCTS_NAME'),
			'a.`description`' => Text::_('COM_CHIRP_PRODUCTS_DESCRIPTION'),
			'a.`image`' => Text::_('COM_CHIRP_PRODUCTS_IMAGE'),
			'a.`brand`' => Text::_('COM_CHIRP_PRODUCTS_BRAND'),
		);
	}
