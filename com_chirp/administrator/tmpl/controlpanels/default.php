...
// }
?>
<dialog id="chirpDialog">
	<div id="chirpLoader"></div>
</dialog>
<header id="chirp_header">
	<div class="chirp_tabs">
		...
		<div id="chirp_tab_c" class="chirp_tab">Shop Settings</div>
		<div id="chirp_tab_d" class="chirp_tab">Customizations</div>
	</div>
</header>
...
<div class="chirp_tab_content" id="chirp_screen3">
	<form action="" method="post" class="chirpForm" name="shopSettings" id="shopSettings" enctype="multipart/form-data">
		<?php echo $configForm->renderFieldset('shopSettings'); ?>
	</form>
</div>
<div class="chirp_tab_content" id="chirp_screen4">
	<h2>Chirp Colors</h2>
	<form action="" method="post" class="chirpForm" name="customSettings" id="customSettings" enctype="multipart/form-data">
		<div id="chirpCustomPreview">
			<div class="chirp" id="chirpTestAlert">
				<div id='chirpProductImage'></div>
				<div id='chirpTopLine'>Adrienne G. from Oak Lawn<br />just purchased a <a href="#">product</a>!</div>
