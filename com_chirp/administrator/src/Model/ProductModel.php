...
class ProductModel extends AdminModel
{
	 ...
	 * @since  0.1.0
	 */
	protected $text_prefix = 'COM_CHIRP';
	 ...
	 * @since  0.1.0
	 */
	public $typeAlias = 'com_chirp.product';
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_chirp.edit.product.data', array());
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_chirp'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__chirp_products');
				$max             = $db->loadResult();
